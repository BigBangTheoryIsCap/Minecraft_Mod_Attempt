...
public class ModTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> NEEDS_BISMUTH_TOOL = createTag("needs_alexandrite_tool");
        public static final TagKey<Block> INCORRECT_FOR_BISMUTH_TOOL = createTag("incorrect_for_alexandrite_tool");
